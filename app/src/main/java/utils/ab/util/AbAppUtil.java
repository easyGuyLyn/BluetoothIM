...
import utils.ab.base.AbAppProcessInfo;
import utils.ab.base.AbCPUInfo;
import utils.ab.base.AbProcessInfo;
import utils.ab.base.AbPsRow;
...
public class AbAppUtil {
    ...
    public static AbProcessInfo getMemInfo(String processName) {
        ...
        if (process.memory == 0) {
            TLogUtils.d("lyn", "##" + processName + ",top -n 1未找到");
        }
        return process;
    }
